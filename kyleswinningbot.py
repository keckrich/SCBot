        ...
        if iteration < 500 and iteration > 30: # we are in the opener 
            ...
            if iteration > 75:
                ...
                for vespene in vespenes:
                    if self.can_afford(UnitTypeId.ASSIMILATOR) and self.already_pending(UnitTypeId.ASSIMILATOR) + self.structures.filter(lambda structure: structure.type_id == UnitTypeId.ASSIMILATOR and structure.is_ready).amount == 0:
